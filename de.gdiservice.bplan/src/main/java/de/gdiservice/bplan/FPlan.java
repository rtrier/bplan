...
//    String id; // "B_Plan.67db195e-9203-4856-9bc9-8ea491153652"
    ...
    public Date getWirksamkeitsdatum() {
        return wirksamkeitsdatum;
    }
    public void setWirksamkeitsdatum(Date wirksamkeitsdatum) {
    ...
    public boolean equals(Object obj) {
        ...
        if (gml_id == null) {
            ...
            return false;        
        if (wirksamkeitsdatum == null) {
            if (other.wirksamkeitsdatum != null)
                return false;
        } else if (!wirksamkeitsdatum.equals(other.wirksamkeitsdatum))
            return false;
        if (name == null) {
            if (other.name != null)
                return false;
        ...
        if (rechtsstand == null) {
            ...
            return false;        
        if (verfahren == null) {
            if (other.verfahren != null)
                return false;
        } else if (!verfahren.equals(other.verfahren))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "FPlan [name=" + name + ", gml_id=" + gml_id + ", nummer=" + nummer + ", planart="
                + planart + ", rechtsstand=" + rechtsstand + ", verfahren=" + verfahren + ", wirksamkeitsdatum=" + wirksamkeitsdatum
                + ", gemeinde=" + gemeinde + ", externereferenz=" + Arrays.toString(externeReferenzes) + "]";
                // + ", geom=" + geom + "]";
    }
