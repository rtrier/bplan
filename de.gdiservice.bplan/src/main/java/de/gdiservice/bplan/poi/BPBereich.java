...
public class BPBereich extends XPBereich<BPlan> {
    ...
    public String toString() {
        String sGeltungsbereich = (geltungsbereich == null ? "null" : geltungsbereich.toString().substring(0, 50)+"...");
        return "BPBereich [versionbaunvodatum=" + versionbaunvodatum + ", versionbaugbtext=" + versionbaugbtext
                ...
                + sGeltungsbereich + ", user_id=" + user_id + ", created_at=" + created_at + ", updated_at=" + updated_at
