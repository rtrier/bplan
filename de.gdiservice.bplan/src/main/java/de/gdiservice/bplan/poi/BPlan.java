...
public class BPlan extends XPPlan implements KeyHolder<UUID> {

    final static Logger logger = LoggerFactory.getLogger(BPlan.class);
    ...
    public LocalDate inkrafttretensdatum; //="2018-01-05"
    public LocalDate rechtsverordnungsdatum;
    public LocalDate ausfertigungsdatum;
    
    // Tabelle xplankonverter.konvertierungen
    public LocalDate veroeffentlichungsdatum;
    
    public Boolean erschliessungsvertrag = null;



    public Boolean durchfuehrungsvertrag = null;


    public Boolean gruenordnungsplan = null;
    
    public Boolean staedtebaulichervertrag = null;
    ...
    public LocalDate[] traegerbeteiligungsStartDatum;
    
    public LocalDate veraenderungssperrebeschlussdatum;
    public LocalDate veraenderungssperredatum;
    public LocalDate veraenderungssperreenddatum;

    public String verlaengerungveraenderungssperre;

    public LocalDate satzungsbeschlussdatum;
    
    public LocalDate aufstellungsbeschlussdatum;

    public LocalDate[] traegerbeteiligungsstartdatum;
    public LocalDate[] traegerbeteiligungsenddatum;




//    public LocalDate genehmigungsdatum;
//    public LocalDate untergangsdatum;
...
//    public PGVerbundenerPlan[] wurdegeaendertvon;
    ...
    // neu
    public CodeList status;
    
    public Gemeinde[] planaufstellendegemeinde;
...
//    }
    ...
    public void setWurdeGeaendertVon(VerbundenerPlan verbundenerPlan) {
        logger.debug("setWurdeGeaendertVon("+(verbundenerPlan!=null ? verbundenerPlan.verbundenerplan : "null")+") Plan mit gmklId="+getGml_id() );
